...
export async function DELETE(req: NextRequest) {
  try {
    ...
    // Delete staff schedules, breaks, holidays first
    await supabaseAdmin.from('staff_schedules').delete().eq('staff_id', id);
    await supabaseAdmin.from('staff_breaks').delete().eq('staff_id', id);
    await supabaseAdmin.from('staff_holidays').delete().eq('staff_id', id);
